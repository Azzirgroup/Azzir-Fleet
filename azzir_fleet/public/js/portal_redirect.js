...
// (covers every login path, including /login?redirect-to=/app). Overseers /
// managers / Administrator are exempt so they can still use the desk.
//
	...
	function maybeRedirect() {
		try {
			...
			const bypass =
				...
				r.includes("Azzir Sales Overseer") ||
